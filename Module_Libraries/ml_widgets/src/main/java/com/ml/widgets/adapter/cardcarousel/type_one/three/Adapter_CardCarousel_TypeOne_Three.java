package com.ml.widgets.adapter.cardcarousel.type_one.three;
...
import static com.ml.widgets.adapter.cardcarousel.type_one.Adapter_CardCarousel_TypeOne_Constans.*;
import static com.ml.widgets.adapter.cardcarousel.type_one.Adapter_CardCarousel_TypeOne_Metrics.*;

/**
 * Created by jcaceres on 07/10/2016.
 */
public class Adapter_CardCarousel_TypeOne_Three extends RecyclerView.Adapter<Adapter_CardCarousel_TypeOne_Three.ViewHolder> {
    ...
    public Adapter_CardCarousel_TypeOne_Three(List<WidgetItem> info, Context context, int widthScreen, boolean isOffset) {
        this.info = info;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        int widthMainLayout = (int)(widthScreen * ADAPTER_TYPEONE_THREE_WIDTH_CARD);
