...
import com.ml.widgets.adapter.cardcarousel.type_one.three.Adapter_CardCarousel_TypeOne_Three;
...
import static com.ml.widgets.adapter.cardcarousel.type_one.Adapter_CardCarousel_TypeOne_Metrics.ADAPTER_TYPEONE_THREE_WIDTH_SEPARATOR;
...
import static com.ml.widgets.widget.background_cardcarousel.type_one.WidgetBackgroundCardCarousel_TypeOne_Constants.*;

/**
 * Created by jcace on 07/10/2016.
 */

public class WidgetBackgroundCardCarousel_TypeOne_Three implements WidgetView {
    ...
    public void inject(Context context, ViewGroup father, final WidgetListener listener, final Widget widget) {
        ...
        if (view != null && cardItems != null && cardItems.size() > 0 ) {
            ...
            if (list != null && cardItems != null){
                ...
                list.addItemDecoration(new WidgetHorizontalSpaceItemDecoration((int) (width * ADAPTER_TYPEONE_THREE_WIDTH_SEPARATOR)));
                list.setAdapter(new Adapter_CardCarousel_TypeOne_Three(cardItems, context, width, isOffset));
