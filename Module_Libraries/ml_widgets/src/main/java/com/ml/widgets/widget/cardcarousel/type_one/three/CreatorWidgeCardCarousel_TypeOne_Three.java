package com.ml.widgets.widget.cardcarousel.type_one.three;
...
import static com.ml.widgets.general.WidgetConstants.WIDGET_CARDCAROUSEL_TYPEONE_THREE;
...
public class CreatorWidgeCardCarousel_TypeOne_Three {

    private static CreatorWidgeCardCarousel_TypeOne_Three instance = null;
    private Widget tempWidget = null;

    public CreatorWidgeCardCarousel_TypeOne_Three() {

    }

    public static CreatorWidgeCardCarousel_TypeOne_Three getInstance(){
        if (instance == null)
            instance = new CreatorWidgeCardCarousel_TypeOne_Three();
        return instance;
    }

    public CreatorWidgeCardCarousel_TypeOne_Three prepareWidget(String url) {

        tempWidget = new Widget();
        tempWidget.setNavUrl(url);
        tempWidget.setItems(new ArrayList<WidgetItem>());
        tempWidget.setType(WIDGET_CARDCAROUSEL_TYPEONE_THREE);
        return this;
    }

    public CreatorWidgeCardCarousel_TypeOne_Three addWidgetItemResource(int image, String title, String subtitle, String price, String lastPrice, String path, String url){
