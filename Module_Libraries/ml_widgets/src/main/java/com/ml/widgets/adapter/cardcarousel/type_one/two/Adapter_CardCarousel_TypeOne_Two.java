package com.ml.widgets.adapter.cardcarousel.type_one.two;
 ...
 */
public class Adapter_CardCarousel_TypeOne_Two extends RecyclerView.Adapter<Adapter_CardCarousel_TypeOne_Two.ViewHolder> {
    ...
    public Adapter_CardCarousel_TypeOne_Two(List<WidgetItem> info, Context context, int widthScreen, boolean isOffset) {
        this.info = info;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        int widthMainLayout = (int)(widthScreen * ADAPTER_TYPEONE_TWO_WIDTH_CARD);
