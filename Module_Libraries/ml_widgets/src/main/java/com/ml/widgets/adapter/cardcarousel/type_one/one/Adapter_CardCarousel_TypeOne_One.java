package com.ml.widgets.adapter.cardcarousel.type_one.one;
 ...
 */
public class Adapter_CardCarousel_TypeOne_One extends RecyclerView.Adapter<Adapter_CardCarousel_TypeOne_One.ViewHolder> {
    ...
    public Adapter_CardCarousel_TypeOne_One(List<WidgetItem> info, Context context, int widthScreen, boolean isOffset) {
        this.info = info;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        int widthMainLayout = (int)(widthScreen * ADAPTER_TYPEONE_ONE_WIDTH_CARD);
