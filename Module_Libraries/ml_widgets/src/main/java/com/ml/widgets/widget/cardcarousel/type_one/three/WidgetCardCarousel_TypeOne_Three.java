...
public class WidgetCardCarousel_TypeOne_Three implements WidgetView {
    ...
    public void inject(Context context, ViewGroup father, final WidgetListener listener, Widget widget) {
        ...
        if (view != null) {
            ...
            if (list != null){
                ...
                list.setAdapter(new Adapter_CardCarousel_TypeOne_Three(widget.getItems(), context, width, false));
            }
