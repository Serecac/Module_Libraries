package com.ml.widgets.widget.background_cardcarousel.type_one.one;
...
import static com.ml.widgets.general.WidgetConstants.WIDGET_BACKGROUND_CARDCAROUSEL_TYPEONE_ONE;
...
public class CreatorWidgeBackgroundCardCarousel_TypeOne_One {

    private static CreatorWidgeBackgroundCardCarousel_TypeOne_One instance = null;
    private Widget tempWidget = null;

    private int numItemsTitle = 0;

    public CreatorWidgeBackgroundCardCarousel_TypeOne_One() {

    }

    public static CreatorWidgeBackgroundCardCarousel_TypeOne_One getInstance(){
        if (instance == null)
            instance = new CreatorWidgeBackgroundCardCarousel_TypeOne_One();
        return instance;
    }

    public CreatorWidgeBackgroundCardCarousel_TypeOne_One prepareWidget(String url) {

        tempWidget = new Widget();
        tempWidget.setNavUrl(url);
        tempWidget.setItems(new ArrayList<WidgetItem>());
        tempWidget.setType(WIDGET_BACKGROUND_CARDCAROUSEL_TYPEONE_ONE);
        numItemsTitle = 0;
        return this;
    }

    public CreatorWidgeBackgroundCardCarousel_TypeOne_One addWidgetItemCard(int image, String title, String subtitle, String price, String lastPrice, String path, String url){
    ...
    public CreatorWidgeBackgroundCardCarousel_TypeOne_One addWidgetItemText(int textsize, int color, int gravity, int style, String text, String typeface){
    ...
    public CreatorWidgeBackgroundCardCarousel_TypeOne_One addWidgetItemImage(int height, int gravity, int resource, String path){
    ...
    public CreatorWidgeBackgroundCardCarousel_TypeOne_One addWidgetItemSeparator(int gravity, int numSeparator){
    ...
    public CreatorWidgeBackgroundCardCarousel_TypeOne_One addWidgetItemConfig(int resource, String path, boolean isOffset){
