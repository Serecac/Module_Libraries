...
import com.ml.widgets.adapter.cardcarousel.type_one.fix_three.Adapter_CardCarousel_TypeOne_FixThree;
...
import static com.ml.widgets.adapter.cardcarousel.type_one.Adapter_CardCarousel_TypeOne_Metrics.ADAPTER_TYPEONE_FIX_THREE_WIDTH_SEPARATOR;

/**
 * Created by jcace on 07/10/2016.
 */

public class WidgetCardCarousel_TypeOne_FixThree implements WidgetView {
    ...
    public void inject(Context context, ViewGroup father, final WidgetListener listener, Widget widget) {
        ...
        if (view != null) {
            ...
            if (list != null){
                ...
                list.addItemDecoration(new WidgetHorizontalSpaceItemDecoration((int) (width * ADAPTER_TYPEONE_FIX_THREE_WIDTH_SEPARATOR)));
                list.setAdapter(new Adapter_CardCarousel_TypeOne_FixThree(widget.getItems(), context, width, false));
            }
